...
export const brands = [
  {
    ...
    rewards: [
      { id: 'carling-reward-001', name: 'Carling branded cap', description: 'A classic cap for your next big moment.', cost: 250 },
      { id: 'carling-reward-002', name: 'R100 instant voucher', description: 'A little something to spend your way.', cost: 100 },
      { id: 'carling-reward-003', name: 'Limited edition cooler', description: 'Keep the good times cool.', cost: 750 },
      { id: 'carling-reward-004', name: 'Match-day experience', description: 'Make the next big moment one to remember.', cost: 300 },
    ],
  },
  {
    id: 'SABSharp-Academy',
    name: 'SABSharp Academy',
    logo: 'https://t1.gstatic.com/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=https://www.sab.co.za&size=128',
    tagline: 'SA Be Sharp',
    description: 'Champion the moments that demand confidence, focus and follow-through.',
    badge: 'Champion Men',
    contentItems: [
      {
        id: 'sabsharp-story-001',
        image: 'https://images.unsplash.com/photo-1516450360452-9312f5e86fc7?auto=format&fit=crop&w=900&q=80',
        type: 'article',
        title: 'Make the moment count',
        summary: 'Small decisions add up to the stories you are proud to tell.',
      ...
      },
      {
        ...
        quiz: {
          questions: [
            { id: 'sabsharp-q1', text: 'What turns a goal into progress?', options: ['A plan and action', 'Waiting for luck', 'Avoiding feedback'], correctIndex: 0 },
            { id: 'sabsharp-q2', text: 'What is the best response to a setback?', options: ['Learn and adjust', 'Give up immediately', 'Ignore it'], correctIndex: 0 },
            { id: 'sabsharp-q3', text: 'Which quality helps a team perform?', options: ['Consistency', 'Silence', 'Blame'], correctIndex: 0 },
          ],
        },
      },
      {
        id: 'sabsharp-story-002',
        image: 'https://images.unsplash.com/photo-1529156069898-49953e39b3ac?auto=format&fit=crop&w=900&q=80',
        type: 'article',
        title: 'Built for the big day',
        summary: 'Meet the people bringing determination to every challenge.',
    ...
    badgeLevels: [
      { id: 'sabsharp-bronze', name: 'Bronze', pointsRequired: 100 },
      { id: 'sabsharp-silver', name: 'Silver', pointsRequired: 300 },
      { id: 'sabsharp-gold', name: 'Gold', pointsRequired: 600 },
    ],
    rewards: [
      { id: 'sabsharp-reward-001', name: 'SABSharp branded cap', description: 'A classic cap for your next big moment.', cost: 250 },
      { id: 'sabsharp-reward-002', name: 'R100 instant voucher', description: 'A little something to spend your way.', cost: 100 },
      { id: 'sabsharp-reward-003', name: 'Limited edition cooler', description: 'Keep the good times cool.', cost: 750 },
  ...
  },
  {
    ...
    rewards: [
      { id: 'partner-reward-001', name: 'Partner coffee voucher', description: 'A warm start from one of our network partners.', cost: 120 },
      { id: 'partner-reward-002', name: 'R200 retail voucher', description: 'More choice at participating retailers.', cost: 200 },
      { id: 'partner-reward-003', name: 'Partner experience pass', description: 'Make your next day out a little sharper.', cost: 350 },
    ],
  },
]
